...
export const WrapperResponsiveTabContent = (props) => {
  ...
  const contentOffsetOptions = [
    { label: __('Not Set', 'whatever'), value: '' },
    { label: __('Content Spacing', 'whatever'), value: 'content-spacing' },
    { label: __('Center', 'whatever'), value: 'center' },
  ];

  const containerWidthOptions = [
    { label: __('Not Set', 'whatever'), value: '' },
    { label: __('Default', 'whatever'), value: 'default' },
  ];
  
  const containerSpacingOptions = [
    { label: __('Not Set', 'whatever'), value: '' },
    { label: __('Default', 'whatever'), value: 'default' },
    { label: __('No Spacing', 'whatever'), value: 'no-spacing' },
  ];
  ...
  return (
    <Fragment>
        ...
        <RangeControl
          label={
            <Fragment>
              ...
              {__('Content Width', 'whatever')}
            </Fragment>
          }
          help={sprintf(__('Change block width in %d columns range. Example 6 = 50% screen width. If you set a value to -1 it will not be used and the parent brakepoint will be used.', 'whatever'), globalSettings.maxCols)}
          value={contentWidth}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Content Offset', 'whatever')}
            </Fragment>
          }
          help={__('Change content position inside a block.', 'whatever')}
          value={contentOffset}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Container Width', 'whatever')}
            </Fragment>
          }
          help={__('Change Container width. Changing this option will affect total width for Content Width option.', 'whatever')}
        ...
        <SelectControl
          label={
            <Fragment>
              ...
              {__('Container Spacing', 'whatever')}
            </Fragment>
          }
          help={__('Change Container spacing on the left and right.', 'whatever')}
        ...
        <RangeControl
          label={
            <Fragment>
              ...
              {__('Spacing Top', 'whatever')}
            </Fragment>
          }
          help={__('Change Block Spacing from the top. If you set a value to -10 it will not be used and the parent brakepoint will be used.', 'whatever')}
          value={spacingTop}
        ...
        <RangeControl
          label={
            <Fragment>
              ...
              {__('Spacing Bottom', 'whatever')}
            </Fragment>
          }
          help={__('Change Block Spacing from the bottom. If you set a value to -10 it will not be used and the parent brakepoint will be used.', 'whatever')}
          value={spacingBottom}
      ...
      {onChangeHideBlock &&
        <ToggleControl
          label={__('Hide Block', 'whatever')}
          help={__('Toggle block visibility.', 'whatever')}
          checked={hideBlock}
