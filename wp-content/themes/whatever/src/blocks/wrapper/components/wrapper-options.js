...
export const WrapperOptions = ({ attributes, actions }) => {
  ...
  return (
    <Fragment>
      <PanelBody title={__('Block Responsive Layout', 'whatever')} initialOpen={false}>
        {onChangeHasWrapper &&
          <ToggleControl
            label={hasWrapper ? __('Wrapper Enabled', 'whatever') : __('Wrapper Disabled', 'whatever')}
            help={__('Toggle wrapper options on/off.', 'whatever')}
            checked={hasWrapper}
        ...
        {hasWrapper &&
          <Fragment>
              ...
              {(tab) => (
                <Fragment>
                  {tab.name === 'large' && (
                    <Fragment>
                      <br />
                      <strong className="notice-title">{__('Large Layout Options', 'whatever')}</strong>
                      <p>{__('This options will only control large screens options.', 'whatever')}</p>
                      <br />
                  ...
                  {tab.name === 'desktop' && (
                    <Fragment>
                      <br />
                      <strong className="notice-title">{__('Desktop Layout Options', 'whatever')}</strong>
                      <p>{__('This options will only control desktop screens options. If nothing is set, parent options will be used.', 'whatever')}</p>
                      <br />
                      <WrapperResponsiveTabContent
                  ...
                  {tab.name === 'tablet' && (
                    <Fragment>
                      <br />
                      <strong className="notice-title">{__('Tablet Layout Options', 'whatever')}</strong>
                      <p>{__('This options will only control tablet screens options. If nothing is set, parent options will be used.', 'whatever')}</p>
                      <br />
                      <WrapperResponsiveTabContent
                  ...
                  {tab.name === 'mobile' && (
                    <Fragment>
                      <br />
                      <strong className="notice-title ">{__('Mobile Layout Options', 'whatever')}</strong>
                      <p>{__('This options will only control mobile screens options. If nothing is set, parent options will be used.', 'whatever')}</p>
                      <br />
                      <WrapperResponsiveTabContent
            ...
            <hr />
            <strong className="notice-title">{__('Block Colors', 'whatever')}</strong>
            <br /><br />
            {onChangeStyleBackgroundColor &&
              <ColorPaletteCustom
                label={
                  <Fragment>
                    ...
                    {__('Background Color', 'whatever')}
                  </Fragment>
                }
                help={__('Change Block Background color. Block spacing will be included in block background color.', 'whatever')}
            ...
            <hr />
            <strong className="notice-title">{__('Block General', 'whatever')}</strong>
            <br /><br />
            {onChangeId &&
              <TextControl
                label={
                  <Fragment>
                    ...
                    {__('Block ID', 'whatever')}
                  </Fragment>
                }
                help={__('Add Unique ID to the block.', 'whatever')}
                value={id}
                onChange={onChangeId}
              />
            }
            ...
            {onChangeAnchor &&
              <TextControl
                ...
                help={__('Adds data-anchor attribut to the block that is used for scroll to option.', 'whatever')}
                value={anchor}
